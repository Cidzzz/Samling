                    ...
                    <div class="flex flex-col gap-4 w-full">
                        ...
                        <div class="flex items-center gap-4 w-full mt-2">
                            <div class="flex-1 bg-gray-100 rounded-full h-4 overflow-hidden">
                                <div class="h-full bg-gray-300 rounded-full" style="width: ${tps.kapasitas}%"></div>
                            </div>
                        ...
                        <div class="flex flex-row items-center justify-between w-full mt-3">
                            ...
                            <div class="flex gap-3">
                                <!-- Tombol Pilih -->
                                <button onclick="pilihTPS('${tps.id}')" class="bg-green-500 hover:bg-green-700 text-white px-6 py-2 rounded-lg text-sm font-medium transition-colors shadow-sm">
                                    Pilih
                                </button>
                                <!-- Tombol Rincian -->
